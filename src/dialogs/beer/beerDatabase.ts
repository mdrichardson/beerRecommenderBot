...
export class BeerDatabase {

  displayRecommendations(style: string) {
    let beerList = beerStyles[style].map(beer => CardFactory.heroCard.apply(this, beer));
    const recommendations = MessageFactory.carousel(beerList);
    return recommendations
  }

  getRecommendations<List>(style: string) {
