...
class BeerStoreLocator {
    ...
    getLatLong(address) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let response;
            try {
                response = yield axios_1.default.get(`http://dev.virtualearth.net/REST/v1/Locations/1%20${address}?o=json&key=Ar9ZMo4JOIeFIQaxXACuvnIEAVMZ5ustcBNmYt6oiFT6LEWN5xLWs2WMIPoIZw5v`);
