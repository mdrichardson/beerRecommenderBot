    ...
    getBeerStoreLocation(address) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                console.log(yield response.data.places);
                console.log(yield response.data.places.value);
                console.log(yield response.data.places.value[0]);
                console.log(yield response.data.places.value[0].entityPresentationInfo);
