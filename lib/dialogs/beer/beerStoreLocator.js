    ...
    getLatLong(address) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                console.log(yield response.data.resourceSets);
                console.log(yield response.data.resourceSets[0].resources);
                console.log(yield response.data.resourceSets[0].resources[0]);
                console.log(yield response.data.resourceSets[0].resources[0].point);
