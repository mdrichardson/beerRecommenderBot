...
const welcome_1 = require("./dialogs/welcome");
    ...
    constructor(conversationState, userState, botConfig) {
                ...
                if (context.activity.membersAdded.length !== 0) {
                    ...
                    for (var idx in context.activity.membersAdded) {
                        ...
                        if (context.activity.membersAdded[idx].id !== context.activity.recipient.id) {
                            ...
                            const welcomeCard = botbuilder_1.CardFactory.adaptiveCard(welcome_1.WelcomeCard);
        ...
        this.isTurnInterrupted = (dc, luisResults) => __awaiter(this, void 0, void 0, function* () {
            ...
            if (topIntent === HELP_INTENT) {
                ...
                yield dc.context.sendActivity(`I understand greetings, being asked for help, or being asked to cancel what I am doing.`);
                return true; // this is an interruption
            }
